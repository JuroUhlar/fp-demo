  ...
  return (
    <NpmPackageIdentificationDemo
      loadOptions={{
        ...
        region: 'us',
        endpoint: `/proxy-dev/result?proxySecret=${environments.anotherEnvironment.proxySecret}&proxyClientIp=54.90.6.179`,
      ...
      name={'Dev JavaScript Agent, Dev custom proxy integration, Public API key <> Proxy Secret environment mismatch ❌'}
