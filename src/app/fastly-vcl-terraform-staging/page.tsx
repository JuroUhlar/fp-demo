...
const integrationUrl = 'http://fastly-vcl.environment.test.global.prod.fastly.net';

export default function ExamplePage() {
  const { environments } = SUBS.environmentsTestStaging;
  const { default: defaultEnvironment, custom } = environments;
  ...
  return (
    <NpmPackageIdentificationDemo
      ...
      name={'Fastly VCL Terraform Staging Environments Test Default env'}
