...
// Terraform module (main branch). Services created empty via the Fastly API,
// then imported + configured by Terraform. See fastly-compute-terraform-latest/main.tf
// and notes/FASTLY_TESTING.md.
const usIntegrationUrl = 'https://crisp-walnut-harbor.edgecompute.app';
const euIntegrationUrl = 'https://mellow-cedar-meadow.edgecompute.app';
const openResponseDecryptionKey = 'kFNxOgVnDbJY4bjNn02tHnR/9ZOebWVMCEQV9Lmolb0=';

export default function FastlyComputeTerraformLatestPage() {
  return (
    <>
      <h1>Fastly Compute Latest via Terraform</h1>
      ...
      <NpmPackageIdentificationDemoV4
        ...
        getOptions={{
          linkedId: 'Fastly Compute Terraform Latest US V4',
        }}
        name="Fastly Compute Terraform Latest US V4"
      ...
      <NpmPackageIdentificationDemo
        ...
        getOptions={{
          linkedId: 'Fastly Compute Terraform Latest US V3',
        }}
        name="Fastly Compute Terraform Latest US V3"
        serverApiKey={SUBS.openResponse.serverApiKey}
        decryptionKey={openResponseDecryptionKey}
      />
      ...
      <NpmPackageIdentificationDemoV4
        ...
        getOptions={{
          linkedId: 'Fastly Compute Terraform Latest EU V4',
        }}
        name="Fastly Compute Terraform Latest EU V4"
      ...
      <NpmPackageIdentificationDemo
        ...
        getOptions={{
          linkedId: 'Fastly Compute Terraform Latest EU V3',
        }}
        name="Fastly Compute Terraform Latest EU V3"
        serverApiKey={SUBS.main.serverApiKey}
      />
    </>
  );
