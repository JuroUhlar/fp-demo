...
const proxySecret = 'Rx215n2tuxp0MUVU3Slm';

export default function ExamplePage() {
  return (
    <NpmPackageIdentificationDemo
      loadOptions={{
        apiKey: '7HL9MhG1k9ivkcCjlvwj',
        region: 'eu',
        endpoint: `/proxy/result?region=eu${spoofedIp ? `&proxyClientIp=${spoofedIp}` : ''}${proxySecret ? `&proxySecret=${proxySecret}` : ''}`,
