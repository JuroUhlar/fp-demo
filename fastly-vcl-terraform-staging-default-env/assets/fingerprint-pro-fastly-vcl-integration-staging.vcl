backend F_fpcdn_io {
    ...
    .host = "procdn.fpjs.sh";
    .host_header = "procdn.fpjs.sh";
    .max_connections = 200;
    .port = "443";
    .share_key = "CqFPQ17V2BKDWIjZuPwLDi";
    .ssl = true;
    .ssl_cert_hostname = "procdn.fpjs.sh";
    .ssl_check_cert = always;
    .ssl_sni_hostname = "procdn.fpjs.sh";
    .probe = {
        .dummy = true;
        .initial = 5;
        .request = "HEAD / HTTP/1.1"  "Host: procdn.fpjs.sh" "Connection: close";
        .threshold = 1;
        .timeout = 2s;
        .window = 5;
...
backend F_api_fpjs_io {
    ...
    .dynamic = true;
    .first_byte_timeout = 15s;
    .host = "api.stage.fpjs.sh";
    .host_header = "api.stage.fpjs.sh";
    .max_connections = 200;
    .port = "443";
    .share_key = "CqFPQ17V2BKDWIjZuPwLDi";
    .ssl = true;
    .ssl_cert_hostname = "api.stage.fpjs.sh";
    .ssl_check_cert = always;
    .ssl_sni_hostname = "api.stage.fpjs.sh";
    .probe = {
        .dummy = true;
        .initial = 5;
        .request = "HEAD / HTTP/1.1"  "Host: api.stage.fpjs.sh" "Connection: close";
        .threshold = 1;
        .timeout = 2s;
        .window = 5;
        .expected_response = 200;
...
backend F_eu_api_fpjs_io {
    ...
    .dynamic = true;
    .first_byte_timeout = 15s;
    .host = "eu.api.stage.fpjs.sh";
    .host_header = "eu.api.stage.fpjs.sh";
    .max_connections = 200;
    .port = "443";
    .share_key = "CqFPQ17V2BKDWIjZuPwLDi";
    .ssl = true;
    .ssl_cert_hostname = "eu.api.stage.fpjs.sh";
    .ssl_check_cert = always;
    .ssl_sni_hostname = "eu.api.stage.fpjs.sh";
    .probe = {
        .dummy = true;
        .initial = 5;
        .request = "HEAD / HTTP/1.1"  "Host: eu.api.stage.fpjs.sh" "Connection: close";
        .threshold = 1;
        .timeout = 2s;
        .window = 5;
        .expected_response = 200;
...
backend F_ap_api_fpjs_io {
    ...
    .dynamic = true;
    .first_byte_timeout = 15s;
    .host = "ap.api.stage.fpjs.sh";
    .host_header = "ap.api.stage.fpjs.sh";
    .max_connections = 200;
    .port = "443";
    .share_key = "CqFPQ17V2BKDWIjZuPwLDi";
    .ssl = true;
    .ssl_cert_hostname = "ap.api.stage.fpjs.sh";
    .ssl_check_cert = always;
    .ssl_sni_hostname = "ap.api.stage.fpjs.sh";
    .probe = {
        .dummy = true;
        .initial = 5;
        .request = "HEAD / HTTP/1.1"  "Host: ap.api.stage.fpjs.sh" "Connection: close";
        .threshold = 1;
        .timeout = 2s;
        .window = 5;
        .expected_response = 200;
